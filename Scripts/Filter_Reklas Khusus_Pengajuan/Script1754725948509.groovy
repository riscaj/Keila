...
WebUI.click(findTestObject('Page_Keila - Pegadaian/a_Pengajuan'))

WebUI.setText(findTestObject('Object Repository/Page_Keila - Pegadaian/input_Filter daftar___BVID__493'), '1100106150020')

WebUI.click(findTestObject('Object Repository/Page_Keila - Pegadaian/button_Filter'))

WebUI.setText(findTestObject('Object Repository/Page_Keila - Pegadaian/input_Filter daftar___BVID__493'), '')

WebUI.setText(findTestObject('Object Repository/Page_Keila - Pegadaian/input_Filter daftar___BVID__494'), 'Baso')
